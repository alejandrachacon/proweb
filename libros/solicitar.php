...
<div class="w3-container" >
  ...
  <form class="w3-container" action="solicitar.php?isbn=<?php if (isset($_GET['isbn'])) echo $_GET['isbn'] ?>&titulo=<?php if (isset($_GET['titulo'])) echo $_GET['titulo'] ?>" method="POST" style="width: 50%">
